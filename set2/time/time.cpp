...
MyTime::MyTime(int hrs,int min,int sec): m_hours(hrs), m_minutes(min), m_seconds(sec)
{
}
...
{
	int hr = m_hours + ref.m_hours;
	int min = m_minutes + ref.m_minutes;
	int sec = m_seconds + ref.m_seconds;
